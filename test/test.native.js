...
tape( 'if provided `0 < beta <= 1` and `alpha > 0`, the function returns `0`', opts, function test( t ) {
	var y;
...
tape( 'the function returns the mode of a log logistic distribution', opts, function test( t ) {
	var expected;
	var alpha;
	var beta;
	var y;
